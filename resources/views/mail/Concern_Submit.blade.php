        ...
        <link
            ...
            <img src="https://th.bing.com/th/id/OIP.7mLt__Duzbo-CN0xL3JT9gHaHa?pid=ImgDet&rs=1" alt="Barangay South SIgnal Village Logo"  class="rounded float-start" alt="southsignal" style="width: 125px ;">
                ...
                <p >
                    ...
                    you that your concern has been submitted.<br><br>
                    <hr>
                    <h3>{{ $data['concern_title'] }}</h3>
                    <p>{{ $data['concern_description'] }}</p>
                    <hr>
                ...
                <p>
                    Track your CONCERN <a href="{{ env('APP_URL')}}/track" class="text-decoration-none">here</a> or go to your user resident accout.
                </p>
                <br>
