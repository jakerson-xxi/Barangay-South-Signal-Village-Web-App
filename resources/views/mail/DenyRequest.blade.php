            ...
            <html lang="en">
                ...
                <body>
                    ...
                    <div class="card">
                        ...
                        <p>We regret to inform you that your request <strong>{{ $data['request_type_name'] }}</strong> with the reference key
                            of <STRONG>{{ $data['ref_key'] }}</STRONG> has been denied. The reason for this denial: </p>
                            <p><strong><em>{{ $data['note'] }}</em> </strong> </p>
