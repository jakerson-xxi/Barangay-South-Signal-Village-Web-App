...
<div class="content my-3">
    <p class="display-6"><i class="bi bi-list-task"></i> <strong>List of Confirmed Payment </strong></p>
    ...
    <table id="resident" class="table table-bordered table-hover" style="width:100%">
        <thead class="table-dark">
            ...
            <tr>
                ...
                <th class="text-center align-middle">OR number</th>
                <th class="text-center align-middle">Name</th>
                <th class="text-center align-middle">Method</th>
                <th class="text-center align-middle">Payment Confirm Date</th>
                <th class="text-center align-middle">Req. Amount</th>
                <th class="text-center align-middle">Service Charge</th>
                <th class="text-center align-middle">Total Amount Paid</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-transform: uppercase;">{{$request->or_num}}</td>
                <td style="text-transform: uppercase;">{{$request->first_name. " ".$request->last_name}}</td>
                <td style="text-transform: uppercase;">
                    @if($request->payment_method == 'ONSITE PAYMENT')
                    {{$request->payment_method}}
                    @else
                    @if($request->payment_method == 'grab_pay')
                    GRAB PAY

                    @elseif($request->payment_method == 'paymaya')
                    MAYA
                ...
                <td style="text-transform: uppercase;">{{$request->payment_confirm}}</td>
                ...
                <td style="text-transform: uppercase" class="text-center">{{$request->payment_processed_by}}</td>
                <td style="text-transform: uppercase; " class="text-center">
                    <a href="{{url('view_Payment')}}/{{$request->payment_id}}" type="submit" class="btn btn-success btn-sm"><i class="bi bi-eye-fill"></i> View</a>
                </td>
            </tr>
            @endforeach
        <tfoot>
